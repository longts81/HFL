...
<li class="has-dropdown header-language-dropdown">
	<ul class="nav-dropdown <?php flatsome_dropdown_classes(); ?>">
		...
		if ( $languages && function_exists( 'pll_the_languages' ) ) {
			...
			foreach ( $languages as $lang ) {
				$current = $current_lang == $lang['native_name'] ? 'class="active"' : '';
				echo '<li '.$current.'><a href="' . $lang['url'] . '" hreflang="' . $lang['language_code'] . '"><i class="icon-image"><img src="' . $lang['country_flag_url'] . '" alt="' . $lang['native_name'] . '"/></i> <span>' . $lang['language_code'] . '</span></a></li>';
			}
		}
